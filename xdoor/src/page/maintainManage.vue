    ...
    <el-row>
      <el-col :span="24">
        ...
        <el-table
          ...
          size="medium"
        >
          <el-table-column type="selection" prop="repairRecordId"></el-table-column>

          <el-table-column prop fixed="left" label="房间" width="120" align="center">
            <template slot-scope="scope">
              <p>{{ scope.row.dongName }}{{ scope.row.floorName }}{{ scope.row.roomName }}</p>
            </template>
          </el-table-column>

          <el-table-column prop="userName" label="报修人" width="100" align="center"></el-table-column>

          <el-table-column prop="userPhone" label="手机号" width="150" align="center"></el-table-column>

          <el-table-column prop label="报修类型" width="150" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column prop="repairRecordCreateTime" label="报修时间" width="180" align="center"></el-table-column>
          ...
          <el-table-column fixed="right" label="操作">
            <template slot-scope="scope">
              ...
              <p v-if="scope.row.repairRecordStatus == 3">{{ scope.row.repairRecordResult }}</p>
        ...
        <el-dialog title="访客登记" :visible.sync="updateDialog" @close="closeDialog()">
          <el-form :model="updateForm" ref="updateForm" label-position="right" label-width="100px">
      ...
      this.$confirm("此操作将永久删除选中文件, 是否继续?", "提示", {
        ...
        .then(() => {
          for (let i = 0; i < ids.length; i++) {
            that.$http.ajax(
              "admin/visitor_record/delete",
              { visitorRecordId: ids[i] },
              function(res) {
                if (res.code == 0) {
                  that.loading = true;
                  that.selectData();
