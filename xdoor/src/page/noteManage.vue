    ...
    <el-row>
      <el-col :span="24">
        ...
        <div class="top-action">
          ...
          <div class="form-search">
            <el-form :inline="true" :model="searchParams">
              ...
              <el-button type="primary" size="medium" icon="el-icon-search" @click="changeSelect"></el-button>
            </el-form>
          </div>
        </div>
        ...
        <el-table
          ...
          size="medium"
        >
          <el-table-column type="selection" prop="workNoteId"></el-table-column>

          <el-table-column prop="workNoteCreateTime" label="时间" width="180" align="center"></el-table-column>

          <el-table-column prop="workNoteContent" label="日志内容" show-overflow-tooltip align="center"></el-table-column>
        </el-table>
        ...
        <el-dialog title="添加日志" :visible.sync="inviteDialog" @close="closeInviteDialog()">
          <el-form :model="inviteForm" ref="inviteForm" label-position="right" label-width="100px">
